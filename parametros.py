...
activities = [
    ...
    # Los siguientes tres (trekking, mtb, kayak) son parametrizados (valores inventados razonables)
    {
        "name": "Trekking",
    ...
    # Señaléticas: invertir o no invertir (decisión 1 = invertir).
    # Supuesto: mejora la experiencia/seguridad; 70% buen resultado (beneficio neto),
    # 30% sobrecosto sin retorno.
    {
        "name": "Señaléticas",
